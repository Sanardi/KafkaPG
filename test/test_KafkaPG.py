...
class KafkaPGOnlineTests(unittest.TestCase):
    """Unit tests for KafkaPG.py that require an internet connection"""
    ...
    def test_request1(self):
        data_expected = 200
        test_url = kafkaPG.KafkaPG(url = "https://google.com")
    ...
    def test_request2(self):
        data_expected = 404
        test_url = kafkaPG.KafkaPG(url = "https://example.com/funny/this-should-not-exist/blafasel")
        test_dict = test_url.make_request()
        data_diff = test_dict["code"]
        self.assertEqual(data_diff, data_expected)
